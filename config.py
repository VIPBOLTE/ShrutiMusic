...
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "https://t.me/supp8iiiny")
...
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/VIPBOLTE/ShrutiMusic")
UPSTREAM_BRANCH = os.getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = os.getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/krishupdates")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/supp8iiiny")
INSTAGRAM = os.getenv("INSTAGRAM", "https://instagram.com/goku_siggma_boy")
YOUTUBE = os.getenv("YOUTUBE", "https://youtube.com/@code_with_harry")
GITHUB = os.getenv("GITHUB", "https://github.com/VIPBOLTE")
DONATE = os.getenv("DONATE", "https://t.me/channelz_k")
